...
export { 
    ...
    BeeIcon as beeicon,
    BirdIcon as birdicon,
    ButterflyIcon as butterflyicon,
    CatIcon as caticon,
    ChickenIcon as chickenicon,
    CowIcon as cowicon,
    CrabIcon as crabicon,
    DogIcon as dogicon,
    DolphinIcon as dolphinicon,
    DonkeyIcon as donkeyicon,
    DuckIcon as duckicon,
    ElephantIcon as elephanticon,
    FalconIcon as falconicon,
    FishIcon as fishicon,
    FlyIcon as flyicon,
    HorseIcon as horseicon,
    KangarooIcon as kangarooicon,
    MouseIcon as mouseicon,
    OctopusIcon as octopusicon,
    OwlIcon as owlicon,
    PeacockIcon as peacockicon,
    PigIcon as pigicon,
    PigeonIcon as pigeonicon,
    SeahorseIcon as seahorseicon,
    SnailIcon as snailicon,
    SpiderIcon as spidericon,
    SquirrelIcon as squirrelicon,
    SwanIcon as swanicon,
